...
graph.add_edge(src: 'A', dest: 'B', weight: 3)
graph.add_edge(src: 'B', dest: 'D', weight: 3)
graph.add_edge(src: 'A', dest: 'D', weight: 1)
graph.add_edge(src: 'B', dest: 'C', weight: 1)
graph.add_edge(src: 'C', dest: 'D', weight: 1)
graph.add_edge(src: 'D', dest: 'E', weight: 6)
graph.add_edge(src: 'C', dest: 'E', weight: 5)
graph.add_edge(src: 'C', dest: 'F', weight: 4)
graph.add_edge(src: 'E', dest: 'F', weight: 2)
